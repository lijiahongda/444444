<template>
  <div class="app-container">
    ...
    <el-table  :data="list.list" :fit="true" border class="table" v-loading="loading" > 
        <el-table-column fixed prop="ordersnSon" label="订单号" align="center" width="180"></el-table-column>
        ...
        <el-table-column prop="memberMobile" label="会员手机号" align="center" width="180"></el-table-column>
        <el-table-column prop="memberTruename" label="会员真实姓名" align="center" width="180"></el-table-column>
        <el-table-column prop="payFormNo" label="支付单号" align="center" width="180"></el-table-column>
        ...
        <el-table-column prop="receiverTel" label="收货手机号" align="center" width="200" fixed="right"></el-table-column>
    </el-table>
...
<script>
import {getMallOrderStatisticsByCategoryOrderGoods} from '@/api/order' // 接口
...
export default {
  ...
  created(){
        this.goodsCategory = this.$route.query ? this.$route.query.goodsCategory : this.$router.query ? this.$router.query
				.goodsCategory : ''
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      this.searchCondition.goodsCategory=this.goodsCategory
      getMallOrderStatisticsByCategoryOrderGoods(this.searchCondition).then(res => {
