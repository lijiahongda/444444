<template>
  <div class="app-container">
    ...
    <el-table  :data="list.list" :fit="true" border class="table" v-loading="loading"> 
        ...
        <el-table-column prop="truename" label="用户姓名" align="center"></el-table-column>
        ...
        <el-table-column fixed="right" label="操作" width="100" align="center">
            <template slot-scope="scope" align="center">
                <router-link :to="{path:'/userManage/user-info',query:{id:scope.row.memberId}}" target="_blank">
...
<script>
import {getMallOrderStatisticsType,getMallOrderStatisticsByMid} from '@/api/order' // 接口
const isMemberGoods = [
    { id: '0', name: '否' },
    { id: '1', name: '是' },
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      getMallOrderStatisticsByMid(this.searchCondition).then(res => {
