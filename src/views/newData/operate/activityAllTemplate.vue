...
<template>
	<div class="app-container">
				...
				<el-form ref="form" label-width="120px" class="list_border">
					<el-row style="height:130px;display: flex;align-items: center;" class="radio-list">
						...
						<el-radio v-model="temType" :label="1">单张模板
							<img v-if='temType ===1'
								src="https://image.yuelvhui.com/pubfile/2019/10/28/line_1572275825_91279.png" alt="">
							<img v-else src="https://image.yuelvhui.com/pubfile/2019/10/29/line_1572278438_38530.png"
								alt="">
						</el-radio>
						<el-radio v-model="temType" :label="2">三张模板
							<img v-if="temType===2"
								src="https://image.yuelvhui.com/pubfile/2019/10/29/line_1572279691_73072.png" alt="">
							<img v-else src="https://image.yuelvhui.com/pubfile/2019/10/28/line_1572276296_31871.png"
								alt="">
						</el-radio>
						<el-radio v-model="temType" :label="3">多张滑动模板
							<img v-if="temType===3"
								src="https://image.yuelvhui.com/pubfile/2019/10/29/line_1572279783_42672.png" alt="">
							<img v-else src="https://image.yuelvhui.com/pubfile/2019/10/28/line_1572276387_29165.png"
								alt="">
						</el-radio>
						<el-radio v-model="temType" :label="4">五张模板
							<img v-if="temType===4"
								src="https://image.yuelvhui.com/pubfile/2019/10/29/line_1572279731_23490.png" alt="">
							<img v-else src="https://image.yuelvhui.com/pubfile/2019/10/28/line_1572276335_33151.png"
								alt="">

						</el-radio>
						<el-radio v-model="temType" :label="5">四张模板
							<img v-if="temType===5"
								src="https://image.yuelvhui.com/pubfile/2019/10/29/line_1572279815_55113.png" alt="">
							<img v-else src="https://image.yuelvhui.com/pubfile/2019/10/28/line_1572276382_65252.png"
								alt="">
						</el-radio>
						<el-radio v-model="temType" :label="7">多张模板
							<img v-if="temType===7"
								src="https://image.yuelvhui.com/pubfile/2019/10/29/line_1572337212_45025.png" alt="">
							<img v-else src="https://image.yuelvhui.com/pubfile/2019/10/29/line_1572337280_54931.png"
								alt="">
						</el-radio>
						<el-radio v-model="temType" :label="8">自定义模板
							<img v-if="temType===8"
								src="https://image.yuelvhui.com/pubfile/2019/10/29/line_1572279783_42672.png" alt="">
							<img v-else src="https://image.yuelvhui.com/pubfile/2019/10/28/line_1572276387_29165.png"
								alt="">
					...
					<el-form-item v-for="(item,index) in templateInfo" :key="index" class="list_border"
						style="width:1000px;margin-left:5px;min-height:200px;">
						...
						<el-row v-if="item.tem_type==8">
							<p style="margin:10px 0;font-size:16px;font-weight:600">模板：{{item.tem_type}}</p>
							<div  style="margin:10px 0">
								<span style="margin-right:20px">背景图：<img :src="item.tem_bgimg" style="width:100px;height:100px;"></span>
								<!-- <span class="">文字图：<img :src="item.word_img"  style="width:150px;height:100px;"></span> -->
							</div>
							<div  style="margin:10px 0">
								<span class="">文字：{{item.word}}</span>
								<span class="">排序：{{item.tem_sort}}</span>
								<span class="">高度：{{item.tem_height}}</span>
								<!-- <div class="tem_span">间隙：{{item.tem_space}}</div> -->
								<span class="">间隙：{{item.tem_space}}</span>
							</div>
							<div v-for="(item1,index1) in item.actityList" :key="index1">
								<div  style="margin:10px 0">
									产品：
									...
									<span v-if="item1.ae_type==41">优券详情</span>
									<span v-if="item1.ae_type==49">品牌</span>
									<span v-if="item1.ae_type==79">淘宝排行榜</span>
									<span v-if="item1.ae_type==102">一分钱抽奖</span>
									<span v-if="item1.ae_type==103">今日爆款</span>
								</div>
								<div style="margin:10px 0">
									<span style="margin-right:20px">封面图：<img :src="item1.ae_img" style="width:100px;height:100px;"></span>
									<span>文字图：<img :src="item1.word_img" style="width:150px;height:100px;"></span>
								</div>
							</div>
						</el-row>
						...
						<div>
							<el-button type="primary" @click="selecShop(item)" plain class="select_shop">编辑模板
							</el-button>
							<el-button type="danger" plain class="" @click="delMoudle(item)">删除模板</el-button>
							<el-button type="info" v-if="item.status=='显示'" plain class=""
								@click="updateTemplate(item,0)">下架</el-button>
							<el-button type="success" v-else plain class="" @click="updateTemplate(item,1)">上架
							</el-button>
						</div>
			...
			<div class="commodity">
				<ul>
					<li @click="choseId(item,product)" v-for="(item,index) in list" :key="index">
						...
						<div v-if="product==5||product==34||product==79">
							<div class="section-p">
								<span>名称：{{item.name}}</span>
							</div>
						</div>
						<div v-if="product==103 || product==33">
							<div class="section-p">
								<span>分享标题：{{item.share_title}}</span>
							</div>
						</div>
						<div v-if="product==102">
							<div class="section-p">
								<span>标题：{{item.lotteryDrawTitle}}</span>
							</div>
						</div>
			...
			<el-form :model="template1" label-width="120px">
				...
				<div>
					<el-form-item label="图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem1"
							:before-upload="beforeAvatarUpload1">
							<span v-for="(item1,index1) in template1.actityList" :key="index1">
								<img v-if="item1.ae_img" :src="item1.ae_img" class="avatar"
				...
				<el-row>
					<el-col :span="24">
						<div class="commodity">
							<ul>
								<li style="border:none" v-for="(item,index) in choseList" :key="index"
									class="selectName">
									<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
									<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
											v-model="item.ae_sort" placeholder="排序"></el-input>
									</div>
									<div style="margin-top:10px" v-if="item.g_id">链接地址：{{item.g_id}}</div>
									<div style="margin-top:10px" v-if="item.activity_name">活动名称：{{item.activity_name}}
									</div>
									...
									<div style="display:flex">
										...
										<img style="margin-top:10px" v-if="item.ac_imgs" :src="item.ac_imgs"
											class="avatar2">
										<div style="margin-top:10px">
											<div v-if="item.goods_name">商品名称：{{item.goods_name}}</div>
											<div style="margin-top:10px" v-if="item.inventory">库存：{{item.inventory}}
											</div>
		...
		<el-dialog width="70%" title="模板2" :visible.sync="dialogTemplate2" @close="closeBox">
			<el-form :model="template2" label-width="120px">
				...
				<el-form-item label="模板背景" class="background_color" style="width: 530px;">
					<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
						:show-file-list="false" :on-success="handleAvatarSuccessshareTem2Bg"
						:before-upload="beforeAvatarUpload1">
						<img v-if="template2.tem_bgimg" :src="template2.tem_bgimg" class="avatar"
							style="width:100px;height:100px;pardding-left:40px">
						<i class="el-icon-plus avatar-uploader-icon" style="margin-top:-100px"></i>
					</el-upload>
				</el-form-item>
				...
				<el-row>
					<el-form-item label="首页图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem2Img1"
							:before-upload="beforeAvatarUpload1">
							<span>
								<img v-if="tem2.ae_img1" :src="tem2.ae_img1" class="avatar"
									style="width:100px;height:100px;pardding-left:40px">
							</span>
							<i class="el-icon-plus avatar-uploader-icon" style="margin-top:-100px"></i>
						</el-upload>
					...
					<el-row>
						<el-col :span="24">
							<div class="commodity">
								<ul>
									<li style="border:none" v-for="(item,index) in choseTem2List1" :key="index"
										class="selectName">
										<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
										<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
												v-model="item.ae_sort" placeholder="排序"></el-input>
										...
										<div style="margin-top:10px" v-if="item.g_id">链接地址：{{item.g_id}}</div>
										<div style="margin-top:10px" v-if="item.activity_name">
											活动名称：{{item.activity_name}}</div>
										<div style="margin-top:10px" v-if="item.share_title">分享标题：{{item.share_title}}
										</div>
										<div style="margin-top:10px" v-if="item.name">优惠券名称：{{item.name}}</div>
										<div style="margin-top:10px" v-if="item.names">名称：{{item.names}}</div>
										<div style="margin-top:10px" v-if="item.ac_name">名称：{{item.channel_name}}</div>
										<div style="display:flex">
											<img style="margin-top:10px" v-if="item.path" :src="item.path"
												class="avatar2">
											<img style="margin-top:10px" v-if="item.ac_imgs" :src="item.ac_imgs"
												class="avatar2">
											<div style="margin-top:10px">
												...
												<div style="margin-top:10px" v-if="item.ac_name">专题名称：{{item.ac_name}}
												</div>
												<div style="margin-top:10px" v-if="item.ac_color">颜色：{{item.ac_color}}
												</div>
											</div>
											<div style="margin-left:20px;margin-top:10px">
												<div v-if="item.origin_price">官网价：¥{{item.origin_price}}</div>
				...
				<el-row>
					<el-form-item label="首页图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem2Img2"
							:before-upload="beforeAvatarUpload1">
							<span>
								<img v-if="tem2.ae_img2" :src="tem2.ae_img2" class="avatar"
									style="width:100px;height:100px;pardding-left:40px">
							</span>
							<i class="el-icon-plus avatar-uploader-icon" style="margin-top:-100px"></i>
						</el-upload>
					...
					<el-row>
						<el-col :span="24">
							<div class="commodity">
								<ul>
									<li style="border:none" v-for="(item,index) in choseTem2List2" :key="index"
										class="selectName">
										<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
										<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
												v-model="item.ae_sort" placeholder="排序"></el-input>
										...
										<div style="margin-top:10px" v-if="item.name">优惠券名称：{{item.name}}</div>
										<div style="margin-top:10px" v-if="item.names">名称：{{item.names}}</div>
										<div style="margin-top:10px" v-if="item.channel_name">名称：{{item.channel_name}}
										</div>
										<div style="display:flex">
											<img style="margin-top:10px" v-if="item.path" :src="item.path"
												class="avatar2">
				...
				<el-row>
					<el-form-item label="首页图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem2Img3"
							:before-upload="beforeAvatarUpload1">
							<span>
								<img v-if="tem2.ae_img3" :src="tem2.ae_img3" class="avatar"
									style="width:100px;height:100px;pardding-left:40px">
							</span>
							<i class="el-icon-plus avatar-uploader-icon" style="margin-top:-100px"></i>
						</el-upload>
					...
					<el-row>
						<el-col :span="24">
							<div class="commodity">
								<ul>
									<li style="border:none" v-for="(item,index) in choseTem2List3" :key="index"
										class="selectName">
										<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
										<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
												v-model="item.ae_sort" placeholder="排序"></el-input>
			...
			<el-form :model="template3" label-width="120px">
				...
				<el-row>
					<el-col :span="24">
						<div class="commodity">
							<ul>
								<li style="border:none;display: flex;align-items: center;justify-content: space-between;width: 90%;"
									v-for="(item,index) in choseList" :key="index" class="selectName">
									<div>
										<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
									...
									<el-button style="height: 40px;" type="danger"
										@click="delTemExtInfo(item.id,index)">删 除</el-button>
								</li>
							</ul>
						</div>
					</el-col>
					...
					<el-row v-if="item1.ae_type==51">
						...
						<el-col :span="20">
							...
							<el-row>
								...
								<el-col :span="20">
									<el-upload class="avatar-uploader"
										action="https://api2.yuelvhui.com/app/third/upload" :show-file-list="false"
										:on-success="(response, file, fileList)=>handleAvatarTem4_1(response, file, fileList,index1)"
										:before-upload="beforeAvatarUpload1">
				...
				<el-row v-if="template4.tem4">
					...
					<el-col :span="20">
						<el-row>
							<el-col :span="4">
								<p
									style="display:flex;width:500px;display: flex;align-items:center;justify-content: flex-start;margin-top:3px">
									<span>排序：</span>
									<el-input v-model="template4.tem4.tem4_1.ae_sort" placeholder="排序" type="number"
						...
						<el-row>
							...
							<el-col :span="20">
								<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
									:show-file-list="false"
									:on-success="(response, file, fileList)=>handleAvatarTem4_act_1(response, file, fileList,1)"
									:before-upload="beforeAvatarUpload1">
									<img v-if="template4.tem4.tem4_1.ae_img" :src="template4.tem4.tem4_1.ae_img"
										class="avatar2">
									<i v-else class="el-icon-plus avatar-uploader-icon"></i>
								</el-upload>
								<span>尺寸:750*770,300kb以内</span>
						...
						<el-row>
							<el-col :span="4">
								<el-button plain @click="selecType(99,4)">选择活动</el-button>
							</el-col>
						</el-row>
						<el-row>
							<!-- 模板4结果 -->
							<el-col :span="24">
								<div class="commodity">
									<ul>
										<li style="border:none;margin-left:-50px;width:400px"
											v-for="(item,index) in tp4List" :key="index" class="selectName">
					...
					<el-col :span="20">
						<el-row>
							<el-col :span="4">
								<p
									style="display:flex;width:500px;display: flex;align-items:center;justify-content: flex-start;margin-top:3px">
									<span>排序：</span>
									<el-input v-model="template4.tem4.tem4_2.ae_sort" placeholder="排序" type="number"
										style="width:80px"></el-input>
								</p>
							</el-col>
						</el-row>
						<el-row>
							...
							<el-col :span="20">
								<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
									:show-file-list="false"
									:on-success="(response, file, fileList)=>handleAvatarTem4_act_1(response, file, fileList,2)"
									:before-upload="beforeAvatarUpload1">
									<img v-if="template4.tem4.tem4_2.ae_img" :src="template4.tem4.tem4_2.ae_img"
										class="avatar2">
									<i v-else class="el-icon-plus avatar-uploader-icon"></i>
								</el-upload>
								<span>尺寸:750*770,300kb以内</span>
						...
						<el-row>
							<el-col :span="4">
								<el-button plain @click="selecType(99,5)">选择活动</el-button>
							</el-col>
						</el-row>
						<el-row>
							<!-- 模板4结果 -->
							<el-col :span="24">
								<div class="commodity">
									<ul>
										<li style="border:none;margin-left:-50px;width:400px"
											v-for="(item,index) in tp5List" :key="index" class="selectName">
											<div v-if="item.activity_name">活动名称：{{item.activity_name}}</div>
											<div v-if="item.share_title">分享标题：{{item.share_title}}</div>
										</li>
									</ul>
		...
		<el-dialog width="70%" title="模板7" :visible.sync="dialogTemplate7" @close="closeBox">
			<el-form :model="template7" label-width="120px">
				...
				<el-row>
					<el-form-item label="首页图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem7Img1"
							:before-upload="beforeAvatarUpload1">
							<span>
								<img v-if="tem7.ae_img1" :src="tem7.ae_img1" class="avatar"
									style="width:100px;height:100px;pardding-left:40px">
							</span>
							<i class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
					...
					<el-row>
						<el-col :span="24">
							<div class="commodity">
								<ul>
									<li style="border:none" v-for="(item,index) in choseTem7List1" :key="index"
										class="selectName">
										<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
										<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
												v-model="item.ae_sort" placeholder="排序"></el-input>
				...
				<el-row>
					<el-form-item label="首页图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem7Img2"
							:before-upload="beforeAvatarUpload1">
							<span>
								<img v-if="tem7.ae_img2" :src="tem7.ae_img2" class="avatar"
									style="width:100px;height:100px;pardding-left:40px">
							</span>
							<i class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
					...
					<el-row>
						<el-col :span="24">
							<div class="commodity">
								<ul>
									<li style="border:none" v-for="(item,index) in choseTem7List2" :key="index"
										class="selectName">
										<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
										<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
												v-model="item.ae_sort" placeholder="排序"></el-input>
				...
				<el-row>
					<el-form-item label="首页图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem7Img3"
							:before-upload="beforeAvatarUpload1">
							<span>
								<img v-if="tem7.ae_img3" :src="tem7.ae_img3" class="avatar"
									style="width:100px;height:100px;pardding-left:40px">
							</span>
							<i class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
					...
					<el-row>
						<el-col :span="24">
							<div class="commodity">
								<ul>
									<li style="border:none" v-for="(item,index) in choseTem7List3" :key="index"
										class="selectName">
										<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
										<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
												v-model="item.ae_sort" placeholder="排序"></el-input>
				...
				<el-row>
					<el-form-item label="首页图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem7Img4"
							:before-upload="beforeAvatarUpload1">
							<span>
								<img v-if="tem7.ae_img4" :src="tem7.ae_img4" class="avatar"
									style="width:100px;height:100px;pardding-left:40px">
							</span>
							<i class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
					...
					<el-row>
						<el-col :span="24">
							<div class="commodity">
								<ul>
									<li style="border:none" v-for="(item,index) in choseTem7List4" :key="index"
										class="selectName">
										<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
										<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
												v-model="item.ae_sort" placeholder="排序"></el-input>
				...
				<el-row>
					<el-form-item label="首页图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem7Img5"
							:before-upload="beforeAvatarUpload1">
							<span>
								<img v-if="tem7.ae_img5" :src="tem7.ae_img5" class="avatar"
									style="width:100px;height:100px;pardding-left:40px">
							</span>
							<i class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
					...
					<el-row>
						<el-col :span="24">
							<div class="commodity">
								<ul>
									<li style="border:none" v-for="(item,index) in choseTem7List5" :key="index"
										class="selectName">
										<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
										<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
												v-model="item.ae_sort" placeholder="排序"></el-input>
				...
				<el-row>
					<el-form-item label="首页图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem7Img6"
							:before-upload="beforeAvatarUpload1">
							<span>
								<img v-if="tem7.ae_img6" :src="tem7.ae_img6" class="avatar"
									style="width:100px;height:100px;pardding-left:40px">
							</span>
							<i class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
					...
					<el-row>
						<el-col :span="24">
							<div class="commodity">
								<ul>
									<li style="border:none" v-for="(item,index) in choseTem7List6" :key="index"
										class="selectName">
										<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
										<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
												v-model="item.ae_sort" placeholder="排序"></el-input>
				...
				<el-row>
					<el-form-item label="首页图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem7Img7"
							:before-upload="beforeAvatarUpload1">
							<span>
								<img v-if="tem7.ae_img7" :src="tem7.ae_img7" class="avatar"
									style="width:100px;height:100px;pardding-left:40px">
							</span>
							<i class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
					...
					<el-row>
						<el-col :span="24">
							<div class="commodity">
								<ul>
									<li style="border:none" v-for="(item,index) in choseTem7List7" :key="index"
										class="selectName">
										<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
										<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
												v-model="item.ae_sort" placeholder="排序"></el-input>
				...
				<el-row>
					<el-form-item label="首页图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem7Img8"
							:before-upload="beforeAvatarUpload1">
							<span>
								<img v-if="tem7.ae_img8" :src="tem7.ae_img8" class="avatar"
									style="width:100px;height:100px;pardding-left:40px">
							</span>
							<i class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
					...
					<el-row>
						<el-col :span="24">
							<div class="commodity">
								<ul>
									<li style="border:none" v-for="(item,index) in choseTem7List8" :key="index"
										class="selectName">
										<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
										<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
												v-model="item.ae_sort" placeholder="排序"></el-input>
				...
				<el-row>
					<el-form-item label="首页图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem7Img9"
							:before-upload="beforeAvatarUpload1">
							<span>
								<img v-if="tem7.ae_img9" :src="tem7.ae_img9" class="avatar"
									style="width:100px;height:100px;pardding-left:40px">
							</span>
							<i class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
					...
					<el-row>
						<el-col :span="24">
							<div class="commodity">
								<ul>
									<li style="border:none" v-for="(item,index) in choseTem7List9" :key="index"
										class="selectName">
										<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
										<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
												v-model="item.ae_sort" placeholder="排序"></el-input>
				...
				<el-row>
					<el-form-item label="首页图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem7Img10"
							:before-upload="beforeAvatarUpload1">
							<span>
								<img v-if="tem7.ae_img10" :src="tem7.ae_img10" class="avatar"
									style="width:100px;height:100px;pardding-left:40px">
							</span>
							<i class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
					...
					<el-row>
						<el-col :span="24">
							<div class="commodity">
								<ul>
									<li style="border:none" v-for="(item,index) in choseTem7List10" :key="index"
										class="selectName">
										<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
										<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
												v-model="item.ae_sort" placeholder="排序"></el-input>
				...
				<el-row>
					<el-form-item label="首页图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem7Img11"
							:before-upload="beforeAvatarUpload1">
							<span>
								<img v-if="tem7.ae_img11" :src="tem7.ae_img11" class="avatar"
									style="width:100px;height:100px;pardding-left:40px">
							</span>
							<i class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
					...
					<el-row>
						<el-col :span="24">
							<div class="commodity">
								<ul>
									<li style="border:none" v-for="(item,index) in choseTem7List11" :key="index"
										class="selectName">
										<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
										<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
												v-model="item.ae_sort" placeholder="排序"></el-input>
		...
		<!-- 模板8 -->
		<el-dialog width="70%" title="模板8" :visible.sync="dialogTemplate8" @close="closeBox">
			<el-form :model="template8" label-width="120px">
				<el-form-item label="背景图">
					<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
						:show-file-list="false" :on-success="handleAvatarSuccess">
						<img v-if="template8.tem_bgimg" :src="template8.tem_bgimg" class="avatar"
							style="width:100px;height:100px;">
						<i v-else class="el-icon-plus avatar-uploader-icon"></i>
					</el-upload>
				</el-form-item>
				<!-- <el-form-item label="文字图">
					<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
						:show-file-list="false" :on-success="txtHandleAvatarSuccess">
						<img v-if="template8.word_img" :src="template8.word_img" class="avatar"
							style="width:100px;height:100px;">
						<i v-else class="el-icon-plus avatar-uploader-icon"></i>
					</el-upload>
				</el-form-item> -->
				<el-form-item label="排序" class="background_color" style="width: 530px;">
					<el-input v-model="template8.tem_sort" placeholder="排序"></el-input>
				</el-form-item>
				<el-form-item label="高度" class="background_color" style="width: 530px;">
					<el-input v-model="template8.tem_height" placeholder="高度"></el-input>
				</el-form-item>
				<el-form-item label="间隙" class="background_color" style="width: 530px;">
					<el-input v-model="template8.tem_space" placeholder="间隙"></el-input>
				</el-form-item>
				<el-form-item label="选择产品" class="background_color" style="width: 530px;">
					<el-select v-model="product" @change="selecType()">
						<el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
									...
									<div>
										...
										<el-form-item label="封面图">
											<el-upload class="avatar-uploader"
												action="https://api2.yuelvhui.com/app/third/upload"
												:show-file-list="false"
												:on-success="(res)=> handleAvatarSuccesstem8(res, index)">
												<img v-if="item.ae_img" :src="item.ae_img" class="avatar"
													style="width:100px;height:100px;">
												<i v-else class="el-icon-plus avatar-uploader-icon"></i>
											</el-upload>
										</el-form-item>
										<el-form-item label="文字图">
											<el-upload class="avatar-uploader"
												action="https://api2.yuelvhui.com/app/third/upload"
												:show-file-list="false"
												:on-success="(res)=> txtHandleAvatarSuccesstem8(res, index)">
												<img v-if="item.word_img" :src="item.word_img" class="avatar"
													style="width:100px;height:100px;">
												<i v-else class="el-icon-plus avatar-uploader-icon"></i>
											</el-upload>
										</el-form-item>
										<div v-if="channel_type  != 'jdOrkaoLa'">文 字：<el-input style="width: 200px;"
												v-model="item.word" placeholder="文字"></el-input>
										</div>

										<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
												v-model="item.ae_sort" placeholder="排序"></el-input>
										</div>
										<div>间 隙：<el-input style="width: 200px;" v-model="item.ae_space"
												placeholder="间隙"></el-input>
										</div>
										<div style="margin-top:10px" v-if="item.g_id">链接地址：{{item.g_id}}</div>
										<div style="margin-top:10px" v-if="item.activity_name">
											活动名称：{{item.activity_name}}</div>
										...
										<div style="margin-top:10px" v-if="item.lottery_draw_title">一分钱抽奖标题：{{item.lottery_draw_title}}
										</div>
										<div style="margin-top:10px" v-if="item.name">优惠券名称：{{item.name}}</div>
										<div style="margin-top:10px" v-if="item.names">名称：{{item.names}}</div>
										<div style="margin-top:10px" v-if="item.brandName">品牌名称：{{item.brandName}}</div>
			...
			<div slot="footer" class="dialog-footer">
				<el-button @click="dialogTemplate8 = false">取 消</el-button>
				<el-button type="primary" @click="update8">确 定</el-button>
			</div>
		</el-dialog>
		<!-- 模板8 -->
		...
		<el-dialog width="70%" title="模板1" :visible.sync="tem1Add" @close="closeBox">
			<el-form :model="tem1AddInfo" label-width="120px">
				...
				<div>
					<el-form-item label="图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem1_add"
							:before-upload="beforeAvatarUpload1">
		...
		<el-dialog width="70%" title="模板2" :visible.sync="tem2Add" @close="closeBox">
			<el-form :model="tem2AddInfo" label-width="120px">
				...
				<el-form-item label="模板背景" class="background_color" style="width: 530px;">
					<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
						:show-file-list="false" :on-success="handleAvatarSuccessshareTem2Bg_add"
						:before-upload="beforeAvatarUpload1">
						<img v-if="tem2AddInfo.tem_bgimg" :src="tem2AddInfo.tem_bgimg" class="avatar"
							style="width:100px;height:100px;pardding-left:40px">
						<i class="el-icon-plus avatar-uploader-icon"></i>
					</el-upload>
				</el-form-item>
						...
						<el-col :span="20">
							...
							<el-row>
								...
								<el-col :span="20">
									<el-upload class="avatar-uploader"
										action="https://api2.yuelvhui.com/app/third/upload" :show-file-list="false"
										:on-success="(response, file, fileList)=>handleAvatarTem4_add_1(response, file, fileList,index1)"
										:before-upload="beforeAvatarUpload1">
										<img v-if="item1.ae_img" :src="item1.ae_img" class="avatar2">
										<i v-else class="el-icon-plus avatar-uploader-icon"></i>
									</el-upload>
					...
					<el-col :span="20">
						<el-row>
							<el-col :span="4">
								<p
									style="display:flex;width:500px;display: flex;align-items:center;justify-content: flex-start;margin-top:3px">
									<span>排序：</span>
									<el-input v-model="tem4AddInfo.tem4.tem4_1.ae_sort" placeholder="排序" type="number"
										style="width:80px"></el-input>
								</p>
							</el-col>
							<!-- <el-col :span="4"><p>排序：{{template4.tem4.tem4_1.ae_sort}}</p></el-col> -->
						...
						<el-row>
							...
							<el-col :span="20">
								<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
									:show-file-list="false"
									:on-success="(response, file, fileList)=>handleAvatarTem4_add_act_1(response, file, fileList,1)"
									:before-upload="beforeAvatarUpload1">
									<img v-if="tem4AddInfo.tem4.tem4_1.ae_img" :src="tem4AddInfo.tem4.tem4_1.ae_img"
										class="avatar2">
									<i v-else class="el-icon-plus avatar-uploader-icon"></i>
								</el-upload>
								<span>尺寸:750*770,300kb以内</span>
					...
					<el-col :span="20">
						<el-row>
							<el-col :span="4">
								<p
									style="display:flex;width:500px;display: flex;align-items:center;justify-content: flex-start;margin-top:3px">
									<span>排序：</span>
									<el-input v-model="tem4AddInfo.tem4.tem4_2.ae_sort" placeholder="排序" type="number"
										style="width:80px"></el-input>
								</p>
							</el-col>
						</el-row>
						<el-row>
							...
							<el-col :span="20">
								<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
									:show-file-list="false"
									:on-success="(response, file, fileList)=>handleAvatarTem4_add_act_1(response, file, fileList,2)"
									:before-upload="beforeAvatarUpload1">
									<img v-if="tem4AddInfo.tem4.tem4_2.ae_img" :src="tem4AddInfo.tem4.tem4_2.ae_img"
										class="avatar2">
									<i v-else class="el-icon-plus avatar-uploader-icon"></i>
								</el-upload>
								<span>尺寸:750*770,300kb以内</span>
		...
		<el-dialog width="70%" title="模板5" :visible.sync="tem5Add" @close="closeBox">
			<el-form :model="template5" label-width="120px">
				...
				<div>
					<el-form-item label="图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem5_add1"
							:before-upload="beforeAvatarUpload1">
							<!-- <span v-for="(item1,index1) in template5.actityList[0]" :key="index1"> -->
							<img v-if="template5.actityList[0].ae_img" :src="template5.actityList[0].ae_img"
								class="avatar" style="width:200px;height:100px;">
							<!-- </span> -->
							<i class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
					</el-form-item>
				...
				<el-row>
					<el-col :span="24">
						<div class="commodity">
							<ul>
								<li style="border:none" v-for="(item,index) in choseTem5List1" :key="index"
									class="selectName">
									<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
									<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
											v-model="item.ae_sort" placeholder="排序"></el-input>
				...
				<div>
					<el-form-item label="图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem5_add2"
							:before-upload="beforeAvatarUpload1">
							<!-- <span v-for="(item1,index1) in template5.actityList[1]" :key="index1"> -->
							<img v-if="template5.actityList[1].ae_img" :src="template5.actityList[1].ae_img"
								class="avatar" style="width:200px;height:100px;">
							<!-- </span> -->
							<i class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
				...
				<el-row>
					<el-col :span="24">
						<div class="commodity">
							<ul>
								<li style="border:none" v-for="(item,index) in choseTem5List2" :key="index"
									class="selectName">
									<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
									<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
											v-model="item.ae_sort" placeholder="排序"></el-input>
				...
				<div>
					<el-form-item label="图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem5_add3"
							:before-upload="beforeAvatarUpload1">
							<!-- <span v-for="(item1,index1) in template5.actityList[2]" :key="index1"> -->
							<img v-if="template5.actityList[2].ae_img" :src="template5.actityList[2].ae_img"
								class="avatar" style="width:200px;height:100px;">
							<!-- </span> -->
							<i class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
				...
				<el-row>
					<el-col :span="24">
						<div class="commodity">
							<ul>
								<li style="border:none" v-for="(item,index) in choseTem5List3" :key="index"
									class="selectName">
									<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
									<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
											v-model="item.ae_sort" placeholder="排序"></el-input>
				...
				<div>
					<el-form-item label="图片" class="background_color" style="width: 530px;">
						<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
							:show-file-list="false" :on-success="handleAvatarSuccessshareTem5_add4"
							:before-upload="beforeAvatarUpload1">
							<!-- <span v-for="(item1,index1) in template5.actityList[3]" :key="index1"> -->
							<img v-if="template5.actityList[3]" :src="template5.actityList[3].ae_img" class="avatar"
								style="width:200px;height:100px;">
							<!-- </span> -->
							<i class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
				...
				<el-row>
					<el-col :span="24">
						<div class="commodity">
							<ul>
								<li style="border:none" v-for="(item,index) in choseTem5List4" :key="index"
									class="selectName">
									<!-- <div>模板：{{moudleList[tem_form.tem_type-1].name}}</div> -->
									<div v-if="channel_type  != 'jdOrkaoLa'">排 序：<el-input style="width: 200px;"
											v-model="item.ae_sort" placeholder="排序"></el-input>
		...
		<!-- 添加模板8 -->
		<el-dialog width="70%" title="模板8" :visible.sync="tem8Add" @close="closeBox">
			<el-form :model="template8" label-width="120px">
				<el-form-item label="背景图">
					<el-upload class="avatar-uploader" action="https://api2.yuelvhui.com/app/third/upload"
						:show-file-list="false" :on-success="handleAvatarSuccess">
			...
			<div slot="footer" class="dialog-footer">
				<el-button @click="tem8Add = false">取 消</el-button>
				<el-button type="primary" @click="addTem8">确 定</el-button>
			</div>
		</el-dialog>
		<!-- 添加模板8 -->
	...
	export default {
		...
		methods: {
			...
			getList() {
				...
				if (this.$route.query.bgId) {
					obj.bgId = this.$route.query.bgId
				}
			...
			selecShop(item) {
				...
				} else if (item.tem_type == 8) {
					this.templateNum = 8;
					this.dialogTemplate8 = true;
					this.template8 = item
			...
			getTabGoods(page) {
				...
				}else if (this.product == 103) {
                  data.page = page
                  data.keyword = this.searchVal
				  data.act_type = 5
                  this.getSeckills(data)
                }else if (this.product == 102) {
                  data.page = page
                  data.keyword = this.searchVal
                  this.getLotteryDraws(data)
                }else if (this.product == 33) {
                  data.page = page
                  data.keyword = this.searchVal
                  data.act_type = 1
                  this.getSeckills(data)
                }else if (this.product == 34) {
                  this.list = [{
                    id: 0,
                    name: '拼团'
                  }]
                }else if (this.product == 79) {
                  this.list = [{
                    id: 0,
                    name: '淘宝排行榜'
                  }]
		  ...
		  // 弹出 一分钱抽奖列表
          getLotteryDraws(data) {
            getLotteryDraws(data).then((res) => {
              if (res.data.code == 200) {
			...
			choseId(item, product) {
				...
				if (product == 39) {
                  ...
                  var goods = {
                    ...
                    names: item.name,
                    ae_sort: 0,
                    lotteryDrawTitle: item.lotteryDrawTitle,
                  }
                }else if (product == 103) {
                  var goods = {
                    // id:item.id,
			...
			update7() {
				...
				if (!(choseTem7List1.length || choseTem7List2.length || choseTem7List3.length || choseTem7List4.length ||
						choseTem7List5.length || choseTem7List6.length || choseTem7List7.length || choseTem7List8.length ||
						choseTem7List9.length || choseTem7List10.length || choseTem7List11.length)) {
					this.$message({
						type: "error",
						message: "请选择产品"
					})
			...
			update8() {
				...
				updateTem8(data).then(res => {
					if (res.data.code == 200) {
						this.dialogTemplate8 = false;
						this.$message.success(res.data.msg || "编辑成功")
						this.getList()
					} else {
						this.$message.error(res.data.msg || "网络开小差了~")
			...
			addTem7() {
				...
				if (!(this.tem7.ae_img1 && this.tem7.ae_img2 && this.tem7.ae_img3 && this.tem7.ae_img4 && this.tem7
						.ae_img5 && this.tem7.ae_img6 && this.tem7.ae_img7 && this.tem7.ae_img8 && this.tem7.ae_img9 &&
						this.tem7.ae_img10 && this.tem7.ae_img11)) {
					this.$message({
						type: "error",
			...
			addTem5() {
				...
				if (choseTem5List1.length == 0 || choseTem5List2.length == 0 || choseTem5List3.length == 0 ||
					choseTem5List4.length == 0) {
					this.$message({
						type: "error",
						message: "请选择产品"
					})
			...
			handleAvatarSuccess(res, file) {
				if (file.response.url) {
					this.$set(this.template8, 'tem_bgimg', file.response.url)
				} else {
					this.$set(this.template8, 'tem_bgimg', '')
				}
			},
			// txtHandleAvatarSuccess(res, file) {
			// 	if (file.response.url) {
			// 		this.$set(this.template8, 'word_img', file.response.url)
			// 	} else {
			// 		this.$set(this.template8, 'word_img', '')
			// 	}
			// },
			handleAvatarSuccesstem8(res, index) {
				console.log(res, index,"1112222")
				if (res.url) {
					this.$set(this.choseList[index], 'ae_img', res.url);
					console.log(this.choseList, 6)
				}
			},
			txtHandleAvatarSuccesstem8(res, index){
				console.log(res, index,"111222233")
				if (res.url) {
					this.$set(this.choseList[index], 'word_img', res.url);
					console.log(this.choseList, 6)
				}
			}
