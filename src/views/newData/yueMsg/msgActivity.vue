...
import { msgNewType,msgNewList,msgDeleted } from '@/api/yueMessage' // 接口
...
export default {
    ...
    methods: {
        //添加、编辑
        addYueMsgClick() {
            this.$router.push({ path: '/yueMsg/msgActivityOptions' })
        },
        // 列表数据
        getList() {
          let self = this;
        ...
        handleEdit(index, row) {
          this.$router.push({ path: '/yueMsg/msgActivityOptions', query: { aid: row.aid }})
