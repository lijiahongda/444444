		...
		<el-dialog :title="titleName" :visible.sync="dialogFormVisible" @close="closeBox">
			<el-form :model="form">
				...
				<el-form-item label="排序:" :label-width="formLabelWidth">
					<el-input v-model="form.sort" autocomplete="off" placeholder="请输入排序,数字越大越靠前"></el-input>
				</el-form-item>
			</el-form>
...
<script>
	...
	import {getCategorys,getCategory,addCategory,updateCategory } from '@/api/shops'
export default {
    directives: {
        waves
    },
    ...
    methods: {
        // 列表数据
        getList() {
			getCategorys({name:this.name,page:this.pageIndex}).then(res=>{
